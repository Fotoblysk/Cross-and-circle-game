...
Board::BoardState Board::squareAction(bool &clicked, int height_index, int width_index, Player *currrent_turn,
...
Board::BoardState Board::checkWin(int height_index, int width_index, Player *currrent_turn) const {
    ...
    counter = 1;
    i = 1;
    while (width_index + i < WIDTH && height_index + i < HEIGHT &&
           board_array[height_index + i][width_index + i].getMarkedBy() == currrent_turn) {
        counter++;
        i++;
    }

    i = 1;
    while (width_index - i >= 0 && height_index - i >= 0 &&
           board_array[height_index - i][width_index - i].getMarkedBy() == currrent_turn) {
        counter++;
        i++;
    }
    ...
    counter = 1;
    i = 1;
    while (width_index - i >= 0 && height_index + i < HEIGHT &&
           board_array[height_index + i][width_index - i].getMarkedBy() == currrent_turn) {
        counter++;
        i++;
    }
    ...
    i = 1;
    while (width_index + i < WIDTH && height_index - i >= 0 &&
           board_array[height_index - i][width_index + i].getMarkedBy() == currrent_turn) {
        counter++;
        i++;
    }
